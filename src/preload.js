...
contextBridge.exposeInMainWorld('api', {
  ...
  addTab: (pageId, name, mode) => ipcRenderer.invoke('tabs:add', { pageId, name, mode }),
  createTab: (name, mode, parentPageId) => ipcRenderer.invoke('tabs:create', { name, mode, parentPageId }),
  ...
  reorderTabs: (ids) => ipcRenderer.invoke('tabs:reorder', { ids }),
  setTabColor: (id, color) => ipcRenderer.invoke('tabs:color', { id, color }),
  loadCache: () => ipcRenderer.invoke('cache:load'),
  saveCache: (tabId, notes) => ipcRenderer.invoke('cache:save', { tabId, notes }),
